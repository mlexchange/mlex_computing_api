...
DEFAULT_TIME = {"submit": datetime.today()}
...
class DockerContainer(BaseModel):
    ...
    data_kwargs: Optional[str] = Field(description="data kwargs")
...
class TimeStamp(BaseModel):
    submit: datetime = Field(description="timestamp of queue submission")
    exec_starts: Optional[datetime] = Field(description="timestamp of start of execution")
    exec_ends: Optional[datetime] = Field(description="timestamp of end of execution")
